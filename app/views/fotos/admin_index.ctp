  ...
  <div class='actions'>
   <ul>
     <li><?php echo $html->link(__('Visualizar', true), "/img/fotos/".$foto['Foto']['foto'],array('class'=>'view')); ?></li>
		 <li><?php echo $html->link(__('Editar', true), array('controller'=>'fotos','action' => 'edit', 'admin'=>true,$foto['Foto']['id'])); ?></li>
		 <li><?php echo $html->link(__('Excluir', true), array('controller'=>'fotos','action' => 'delete', 'admin'=>true,$foto['Foto']['id']), null, sprintf(__('Tem certeza que deseja excluir o registro # %s?', true), $foto['Foto']['id'])); ?></li>
   </ul>
 </div>
</div>
<?php endforeach; ?>

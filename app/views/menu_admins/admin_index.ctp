...
?>
    ...
    <td><?php echo $item['MenuAdmin']['link']; ?></td>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Excluir', true), array('action' => 'admin_delete', $item['MenuAdmin']['id']), null, sprintf(__('Tem certeza que deseja excluir o registro # %s?', true), $item['MenuAdmin']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>

...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Excluir', true), array('action' => 'admin_delete', $this->Form->value('MenuAdmin.id')), null, sprintf(__('Tem certeza que deseja excluir o registro  # %s?', true), $this->Form->value('MenuAdmin.id'))); ?></li>
